...
public class Player : MonoBehaviour
{
    ...
    void Grenade()
    {
        ...
        if(gDown && !isReload && !isSwap && !isShop)
        {
            ...
            if (Physics.Raycast(ray, out rayHit, 100))
            {
                ...
                GameObject instantGrenade = Instantiate(granadeObj, transform.position, transform.rotation);
    ...
    {
        isDamage = true;
        foreach(MeshRenderer mash in mashs)
        {
            mash.material.color = Color.yellow;
        }
        ...
        foreach (MeshRenderer mash in mashs)
        {
            mash.material.color = Color.white;
        }
